...
I have experience with Java, Python, JavaScript, SQL, React, Node.js/Express and Spring Boot. I am comfortable working with REST APIs, frontend and backend applications, database, debugging, Git/GitHub. I also have experience with machine learning and AI projects using Python.
I prefer issues involving AI/ML, backend development, APIs, data processing, debugging or full-stack development. I am interested in issues where I can learn new technologies while applying my existing skills.
